...
const person = {
  firstName: "Gaetan",
  lastname: "Asselberghs",
  age: 52,
  dateOfBirth: new Date(1969, 4,28, 5, 58, 00)
};
console.log(person);
...
console.log("Hoi! Ik ben "+ person.firstName + ", ik ben " + person.age);
...
const pitch = ("De " + product.productName + " is gemaakt van " + product.material[0] + " en " +  product.material[1]);
console.log(pitch);
